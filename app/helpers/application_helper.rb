module ApplicationHelper
  ...
  def primary_button_class
    "px-2 py-1 shadow-sm text-white bg-sky-500 font-bold hover:bg-sky-600 transition-all disabled:opacity-30 cursor-pointer flex items-center space-x-1 rounded"
  end
  ...
  def nav_class
    "w-full flex items-center shadow-sm font-bold dark:border-dark-border sticky space-x-3 z-[50] bg-background dark:bg-dark-background dark:text-gray-200 text-gray-700 bg-opacity-60 dark:bg-opacity-60 backdrop-filter backdrop-blur-lg dark:backdrop-blur-lg dark:backdrop-filter relative mb-4 h-[40px]"
  end
  ...
  def block_link_class
    "py-1 px-2 block hover:bg-gray-50 rounded dark:hover:bg-gray-700 transition-all dark:text-gray-200 flex items-center space-x-1 font-bold text-gray-700 hover:shadow-sm transition-all"
  end
