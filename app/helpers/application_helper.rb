module ApplicationHelper
  ...
  def nav_class
    "w-full flex items-center shadow font-bold dark:border-dark-border sticky space-x-3 top-0 z-[50] bg-background dark:bg-dark-background dark:text-gray-200 text-gray-700"
  end
  ...
  def card_class
    "relative bg-white p-4 sm:p-8 rounded-lg shadow mb-4 dark:text-gray-200 dark:bg-dark-card dark:border dark:border-dark-border dark:text-gray-200"
  end
