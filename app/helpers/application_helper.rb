module ApplicationHelper
  ...
  def dropdown_class
    "overflow-scroll absolute top-10 right-0 z-[100] hidden w-72 bg-white dark:bg-[rgb(30,39,50)] shadow rounded-lg border dark:border-[rgb(48,54,61)] scollbar-none"
  end
